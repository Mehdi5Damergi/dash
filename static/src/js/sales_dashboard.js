...
//Initializes the SalesDashboard component,
    setup() {
    ...
    //  Function to fetch all the pos details
        var result = await this.orm.call('sale.order','get_refund_details',[])
        ...
        var data =  await this.orm.call('sale.order','get_details',[])
    ...
    //  To get the Sale bar chart
       ...
       var self = this
        var ctx = $("#canvas_1");
        this.orm.call('sale.order', 'get_department',[option])
    ...
    //      To render the top customer pie chart
       ...
       this.orm.call('sale.order', 'get_the_top_customer')
        .then(function (arrays) {
          var data = {
            labels: arrays[1],
            datasets: [
    ...
    render_top_product_graph (){
     //   To render the top product graph
       ...
       this.orm.call('sale.order', 'get_the_top_products')
            .then(function (arrays) {
          var data = {
    ...
    render_product_category_graph (){
        ...
        this.orm.call('sale.order', 'get_the_top_categories')
            .then(function (arrays) {
          var data = {
            labels: arrays[1],
            datasets: [
...
registry.category("actions").add("sales_dashboard_menu", SalesDashboard)
